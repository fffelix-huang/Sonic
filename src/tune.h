...
TUNE_PARAM(DELTA_MARGIN, 504, 100, 3000);
TUNE_PARAM(RFP_BASE, 208, 50, 900);
TUNE_PARAM(RFP_MULTIPLIER, 115, 20, 500);
TUNE_PARAM(FP_BASE, 173, 50, 900);
TUNE_PARAM(FP_MULTIPLIER, 128, 20, 500);
